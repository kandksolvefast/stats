...
**Status:** [Planning | In Progress | Complete] | **Last Updated:** YYYY-MM-DD
...
**File:** `src-tauri/src/readers/[module].rs`
...
**Description:** Fetch current snapshot of [module] data.
...
**Location:** `src/stores/[module]Store.ts`
...
**Backend:**
- [ ] `[module]_reader_tests.rs` - Reader logic
- [ ] `[module]_data_serialization_test` - JSON serialization
...
**Backend:**
- [`src-tauri/src/readers/[module].rs`](../../src-tauri/src/readers/[module].rs)
- [`src-tauri/src/commands/[module].rs`](../../src-tauri/src/commands/[module].rs)
- [`src-tauri/src/tests/[module]_tests.rs`](../../src-tauri/src/tests/[module]_tests.rs)

**Frontend:**
- [`src/modules/[Module]/`](../../src/modules/[Module]/)
- [`src/stores/[module]Store.ts`](../../src/stores/[module]Store.ts)
...
|---------|------|---------|--------|
| 1.0 | YYYY-MM-DD | Initial module spec | Author Name |
