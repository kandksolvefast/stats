...
**File:** `src-tauri/src/readers/disk.rs`
...
**Description:** Fetch current snapshot of disk data.
...
**Location:** `src/stores/diskStore.ts`
...
**Backend:**
- [ ] `disk_reader_tests.rs` - Reader logic
- [ ] `disk_data_serialization_test` - JSON serialization
...
**Backend:**
- [`src-tauri/src/readers/disk.rs`](../../src-tauri/src/readers/disk.rs)
- [`src-tauri/src/commands/disk.rs`](../../src-tauri/src/commands/disk.rs)
- [`src-tauri/src/tests/disk_tests.rs`](../../src-tauri/src/tests/disk_tests.rs)

**Frontend:**
- [`src/modules/[Module]/`](../../src/modules/[Module]/)
- [`src/stores/diskStore.ts`](../../src/stores/diskStore.ts)
- [`src/types/disk.ts`](../../src/types/disk.ts)
