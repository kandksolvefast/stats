...
**File:** `src-tauri/src/readers/ram.rs`
...
**Description:** Fetch current snapshot of ram data.
...
**Location:** `src/stores/ramStore.ts`
...
**Backend:**
- [ ] `ram_reader_tests.rs` - Reader logic
- [ ] `ram_data_serialization_test` - JSON serialization
...
**Backend:**
- [`src-tauri/src/readers/ram.rs`](../../src-tauri/src/readers/ram.rs)
- [`src-tauri/src/commands/ram.rs`](../../src-tauri/src/commands/ram.rs)
- [`src-tauri/src/tests/ram_tests.rs`](../../src-tauri/src/tests/ram_tests.rs)

**Frontend:**
- [`src/modules/[Module]/`](../../src/modules/[Module]/)
- [`src/stores/ramStore.ts`](../../src/stores/ramStore.ts)
- [`src/types/ram.ts`](../../src/types/ram.ts)
